...
public class ResuableMethodsPerformanceScore extends BaseClass {
	...
	public void trialProjectScoreVerificaion(){
		...
		WebUI.verifyMatch(wasteScore, "", false, FailureHandling.CONTINUE_ON_FAILURE)
		WebUI.verifyMatch(transportationScore, "", false, FailureHandling.CONTINUE_ON_FAILURE)
		WebUI.verifyMatch(humanExpScore, "", false, FailureHandling.CONTINUE_ON_FAILURE)
