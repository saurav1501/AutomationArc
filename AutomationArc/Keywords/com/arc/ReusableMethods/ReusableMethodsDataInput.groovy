...
public class ReusableMethodsDataInput  extends BaseClass{
	...
	public void verifyFilterDataInput(){
		...
		Assert.assertEquals(WebUI.getAttribute(findTestObject('Object Repository/DataInput/CreateMeterBuilding/wasteGeneratedReadingOne'),'value'),'1545')
		Assert.assertEquals(WebUI.getAttribute(findTestObject('Object Repository/DataInput/CreateMeterBuilding/wasteDivertedReadingOne'),'value'),'700')
		Assert.assertEquals(WebUI.getAttribute(findTestObject('Object Repository/DataInput/CreateMeterBuilding/EditMeterStartDate'), 'value'),"May 01, 2018")
		Assert.assertEquals(WebUI.getAttribute(findTestObject('Object Repository/DataInput/CreateMeterBuilding/EditMeterEndDatePicker'), 'value'), "May 31, 2018")
	...
	public void percentageSurveyResponseRateCalculationBuiding() throws IOException, InterruptedException, Exception{
		...
		WebUI.delay(3)
		String projectoccupancy = WebUI.getText(findTestObject('Object Repository/DataInput/CreateMeterBuilding/BuildingSettingDataFieldOne'))
	    double projectOccupancy= Double.parseDouble(projectoccupancy)
