...
// verify if the submit payment review via CC has CCV and Expiary date enabled
try{
	...
	CustomKeywords.'com.arc.ReusableMethods.ReusableMethodsPayment.verifyPaymentByCCHasCCExpiaryAndCVVEnabled'()
