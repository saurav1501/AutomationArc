...
//Add new Project Test
	...
	try {
        ...
        CustomKeywords.'com.arc.ReusableMethods.ReusableMethodsSubmitReview.addCertificationFromAdminToolForBuildings'(GlobalVariable.BuildingSheet, GlobalVariable.rowNumEleven)
		...
		CustomKeywords.'com.arc.ReusableMethods.ReusableMethodsManage.certificationDetailVerificationForPointsAddedFromAdminTool'(GlobalVariable.BuildingSheet, GlobalVariable.rowNumEleven)
